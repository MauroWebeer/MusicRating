...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post musics_url, params: { music: { album: @music.album, artist: @music.artist, name: @music.name } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { album: @music.album, artist: @music.artist, name: @music.name } }
